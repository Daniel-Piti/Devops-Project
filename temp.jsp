    ...
    <body>
    <a>Bitcoin is a cryptocurrency invented in 2008 by an unknown person or group of people using the name Satoshi Nakamoto.<br/>
    The currency began use in 2009 when its implementation was released as open-source software.<br/>
    Bitcoin is a decentralized digital currency,<br/>without a central bank or single administrator,<br/>
